  ...
  return (
    <label className="grid gap-2 text-[13px] font-semibold text-[#20242a]" htmlFor={name}>
      ...
      <span className="relative flex items-center">
        ...
        <input id={name} name={name} type={type} placeholder={placeholder} required className="h-[50px] w-full rounded-[10px] border border-[#e1e5ea] bg-white pl-10 pr-11 text-base text-[#242a31] outline-none transition focus:border-[#fb7118] focus:ring-4 focus:ring-[#fb7118]/10" />
