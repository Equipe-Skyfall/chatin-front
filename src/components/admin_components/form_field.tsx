...
export const primaryButtonClassName =
  "rounded-[8px] bg-orange-light px-3 py-1.5 text-[10px] font-semibold text-white transition-opacity hover:opacity-90 disabled:opacity-50";
export const ghostButtonClassName =
  "rounded-[8px] border border-line px-3 py-1.5 text-[10px] font-semibold text-gray transition-colors hover:border-orange hover:text-orange disabled:opacity-50 disabled:hover:border-line disabled:hover:text-gray";
