...
export function SupportMaterials() {
  return (
    <aside className="hidden w-[232px] shrink-0 bg-surface px-4 py-5 shadow-neo-raised xl:block">
      ...
      <button className="mt-2 flex h-[74px] w-full flex-col items-center justify-center rounded-xl bg-surface text-[10px] text-gray shadow-neo-inset transition-colors hover:text-orange">
