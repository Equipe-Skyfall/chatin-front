...
export function LoginAside() {
  return (
    <aside className="relative flex min-h-[460px] flex-col overflow-hidden bg-[#171717] px-6 py-7 text-white sm:px-10 sm:py-10 lg:min-h-screen">
      ...
      <div className="relative z-10 mx-auto mt-12 aspect-[1.020] w-full max-w-[440px] overflow-hidden rounded-[30px] border-[8px] border-white/15 bg-[#df8d6b] shadow-[0_24px_44px_rgba(0,0,0,.35)] sm:mt-[72px] lg:mt-16">
      ...
      <div className="relative z-10 mt-auto hidden lg:block">
        <div className="mt-12 flex max-w-[270px] items-center gap-2 rounded-[18px] border border-white/10 bg-white/[.06] px-4 py-3.5 text-[12px] leading-4 text-white/55"><span className="flex -space-x-2 text-[#fb7118]"><span className="grid size-7 place-items-center rounded-full border-2 border-[#27211d] bg-[#e9b49a]">●</span><span className="grid size-7 place-items-center rounded-full border-2 border-[#27211d] bg-[#4e8291]">●</span><span className="grid size-7 place-items-center rounded-full border-2 border-[#27211d] bg-[#d9a54d]">●</span></span><span>Junte-se a mais de <strong className="text-white">10.000+ estudantes</strong> na plataforma.</span></div>
        <div className="mt-7 flex justify-between gap-4 text-[10px] font-bold tracking-[.12em] text-white/35"><span>© 2024 CHATIN. TODOS OS DIREITOS RESERVADOS.</span><span>PRIVACIDADE&nbsp;&nbsp; TERMOS</span></div>
      </div>
    </aside>
  );
}